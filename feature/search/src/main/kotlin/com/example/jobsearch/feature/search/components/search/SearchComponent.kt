...
import com.example.jobsearch.feature.search.components.search.param.SearchComponentPreviewParam
import com.example.jobsearch.feature.search.components.search.param.SearchComponentProvider
...
private fun PreviewSearchComponent(
    @PreviewParameter(SearchComponentProvider::class) param: SearchComponentPreviewParam,
) {
    DefaultPreview {
        SearchComponent(
